...
var BookCard = function (_JetView) {
	...
	BookCard.prototype.config = function config() {
		...
		return {
			...
			body: {
				view: 'scrollview',
				body: {
					rows: [bookCover, bookCard, availableTextFiles, availableAudioFiles, filesList, audioList, {
	...
	BookCard.prototype.showPopup = function showPopup(book) {
		...
		_models_files__WEBPACK_IMPORTED_MODULE_4__["default"].getDataFromServer().then(function (dbData) {
